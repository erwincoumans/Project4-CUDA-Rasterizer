...
uniform vec3 unf8;
const float cons16 = float(1.000000000000);
...
void main()
{
	...
	shade_add_mirror(unf8, tmp1, tmp7.rgb, tmp11);
	shade_add(vec4(tmp11, 1.0), tmp5, tmp14);
	mtex_alpha_to_col(tmp14, cons16, tmp17);
	shade_mist_factor(varposition, unf19, unf20, unf21, unf22, unf23, tmp24);
	mix_blend(tmp24, tmp17, unf27, tmp28);
	shade_alpha_opaque(tmp28, tmp30);
	linearrgb_to_srgb(tmp30, tmp32);
